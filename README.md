...
> 📝 **Artículo relacionado**: [🔌 MCP Server como proxy de otro MCP Server](https://www.returngis.net/2026/02/%f0%9f%94%8c-mcp-server-como-proxy-de-otro-mcp-server/)
...
> **NOTA**: La arquitectura actual está diseñada para **desarrollo y demos**.
> Para producción con múltiples usuarios, consulta el [issue #7](https://github.com/0GiS0/mcp-server-as-a-proxy/issues/7).
...
- Gunicorn con workers: `gunicorn proxy_server:proxy -w 4 -k uvicorn.workers.UvicornWorker`
- Kubernetes con réplicas
